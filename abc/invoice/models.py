...
class Invoice(models.Model):
    ...
    total_tax = models.DecimalField(max_digits=9, decimal_places=2, blank=True, null=True)
    with_tax = models.DecimalField(max_digits=9, decimal_places=2, blank=True, null=True)
